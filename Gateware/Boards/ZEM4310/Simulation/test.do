...
vlog -vlog01compat -work work +incdir+$HPC/testbench $HPC/testbench/ddr2_interface_full_mem_model.v

#Opal Kelly Simulation Source
vlog -vlog01compat -work work +incdir+$OKSIM $OKSIM/glbl.v 
vlog -vlog01compat -work work +incdir+$OKSIM $OKSIM/okHost.v
vlog -vlog01compat -work work +incdir+$OKSIM $OKSIM/okWireOR.v
vlog -vlog01compat -work work +incdir+$OKSIM $OKSIM/okWireIn.v
vlog -vlog01compat -work work +incdir+$OKSIM $OKSIM/okWireOut.v
vlog -vlog01compat -work work +incdir+$OKSIM $OKSIM/okTriggerIn.v
vlog -vlog01compat -work work +incdir+$OKSIM $OKSIM/okTriggerOut.v
vlog -vlog01compat -work work +incdir+$OKSIM $OKSIM/okPipeIn.v
vlog -vlog01compat -work work +incdir+$OKSIM $OKSIM/okPipeOut.v
vlog -vlog01compat -work work +incdir+$OKSIM $OKSIM/okBTPipeIn.v
vlog -vlog01compat -work work +incdir+$OKSIM $OKSIM/okBTPipeOut.v

#Megafunctions
vlog -vlog01compat -work work +incdir+$HPC  ../Megafunctions/fifo_w64_1024_r64_1024.v
vlog -vlog01compat -work work +incdir+$HPC  ../Megafunctions/fifo_w64_1024_r32_2048.v
vlog -vlog01compat -work work +incdir+$HPC  ../Megafunctions/extclk_pll.v
vlog -vlog01compat -work work +incdir+$HPC  ../Megafunctions/pixclk_pll.v
vlog -vlog01compat -work work +incdir+$HPC  ../Megafunctions/ram16x8.v

#EVB1006
vlog -vlog01compat -work work +incdir+$HPC  ../okcamera.v
vlog -vlog01compat -work work +incdir+$HPC  ../clocks.v
vlog -vlog01compat -work work +incdir+$HPC  ../host_if.v
vlog -vlog01compat -work work +incdir+$HPC  ../image_if.v
vlog -vlog01compat -work work +incdir+$HPC  ../mem_arbiter.v
vlog -vlog01compat -work work +incdir+$HPC  ../memif.v
vlog -vlog01compat -work work +incdir+$HPC  ../sync_reset.v
vlog -vlog01compat -work work +incdir+$HPC  ../I2C/i2cController.v

#Sensor Simulation
vlog -vlog01compat -work work +incdir+$OKSIM  ../../Simulation/sensor_sim.v

#Test Fixture
vlog -vlog01compat -work work +incdir+$OKSIM  ./test_tf.v
