...
# PORTA-22 (S17)
set_property PACKAGE_PIN AD18 [get_ports {pcam_iic_scl_io}]
set_property IOSTANDARD LVCMOS12 [get_ports {pcam_iic_scl_io}]
set_property DRIVE 8 [get_ports {pcam_iic_scl_io}]
# PORTA-24 (S19)
set_property PACKAGE_PIN AE18 [get_ports {pcam_iic_sda_io}]
set_property IOSTANDARD LVCMOS12 [get_ports {pcam_iic_sda_io}]
set_property DRIVE 8 [get_ports {pcam_iic_sda_io}]
# PORTA-21 (S16)
set_property PACKAGE_PIN AC16 [get_ports {pcam_power_en}]
